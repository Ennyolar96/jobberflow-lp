      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 md:py-32">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <motion.h1
            ...
            className="font-inter font-extrabold text-4xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tight leading-[1.08] mb-6"
          >
            Ace Your Interviews.{" "}
          ...
          >
            Jobberflow is an open-source mobile app designed to help job seekers
            prepare, improve, and apply smarter — all in one place.
          </motion.p>
          ...
          >
            <Button
              size="lg"
              className="rounded-full px-8 h-12 text-base font-inter font-semibold gap-2 shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all"
              asChild
            >
            ...
            <Button
              variant="outline"
              size="lg"
              className="rounded-full px-8 h-12 text-base font-inter font-semibold gap-2"
              asChild
            >
              <a
          ...
          >
            <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4">
              {[
                ...
                <div
                  key={item.label}
                  className={`flex items-center gap-2.5 px-5 py-3 rounded-2xl bg-gradient-to-br ${item.color} border backdrop-blur-sm animate-float`}
